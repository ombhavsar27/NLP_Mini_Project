...
city_table = pd.read_csv("D:\\VS Code\\NLP Mini Project\\NLP_Mini_Project\\data\\cities.csv")["name"].tolist()
state_table = pd.read_csv("D:\\VS Code\\NLP Mini Project\\NLP_Mini_Project\\data\\states.csv")["name"].tolist()
