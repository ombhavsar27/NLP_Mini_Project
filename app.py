...
# Load sample data
country_table = pd.read_csv("D:\\VS Code\\NLP Mini Project\\data\\countries.csv")["name"].tolist()
city_table = pd.read_csv("D:\\VS Code\\NLP Mini Project\\data\\cities.csv")["name"].tolist()
state_table = pd.read_csv("D:\\VS Code\\NLP Mini Project\\data\\states.csv")["name"].tolist()
